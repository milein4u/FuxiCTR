...
if __name__ == '__main__':
    ...
    parser.add_argument('--expid', type=str, default='AFM_criteo', help='The experiment id to run.')
    ...
    # Safely evaluate important stringified fields
    ...
    # Prepare list of feature columns for FeatureProcessor
    feature_cols_for_processor = []
    for feature_name in params['use_features']:
        if feature_name in params['feature_specs']:
            col_spec = params['feature_specs'][feature_name].copy()
            col_spec['name'] = feature_name
            feature_cols_for_processor.append(col_spec)
        else:
            print(f"WARNING: Feature '{feature_name}' not found in feature_specs.")
    ...
    # ✅ Fix: overwrite feature_specs with structured list of dicts
    params["feature_specs"] = feature_cols_for_processor
